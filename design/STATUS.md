...
2. Read Part 0 of [rules-002.md](rules-002.md).
3. Read the plan, [implementation-plan-003.md](implementation-plan-003.md), for
...
| design decisions, and what paternitas keeps from ztk | [paternitas-design-002.md](paternitas-design-002.md) |
| the plan | [implementation-plan-003.md](implementation-plan-003.md) |
...
[implementation-plan-003.md](implementation-plan-003.md).
