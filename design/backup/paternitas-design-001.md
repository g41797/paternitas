...
- The rules are in [rules-002.md](rules-002.md).
...
- `rules-002.md` is a trimmed copy of `ZTK/design/rules-050.md`.
...
- Two passes.
  - INTR 15 does a quick pass before `rules-002.md` is written. It fixes what
