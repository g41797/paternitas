# paternitas — Rules (002)

All coding, doc, and process rules for paternitas.

Change from 001: the heading "Status file ownership" became "Status files —
where each fact lives". The old heading held a banned word. Owner's ruling,
2026-09-25.
...
Companion: [paternitas-design-002.md](paternitas-design-002.md) — the design
...
5. Code.
6. Gates, in the order of Part 0.
...
`kitchen/tools/check_docs.sh` enforces the single-word part of the list below.
